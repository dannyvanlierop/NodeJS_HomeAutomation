...
exports.getManufacturerName = function( iLightNumber ){ client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.manufacturername === undefined ) return err;    exec("/bin/echo '" + `${result.manufacturername}` + "' > " + pathresources + "/hue/light/" + iLightNumber + "/manufacturername" );   sArrayLightManufacturerName[iLightNumber] = result.manufacturername;    });};    //if ( debug ){ console.log(`    Manufacturername: ${result.manufacturername}`);};});};
exports.getProductName = function( iLightNumber ){      client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.productname === undefined ) return err;         exec("/bin/echo '" + result.productname + "' > " + pathresources + "/hue/light/" + iLightNumber + "/productname" );             sArrayLightProductname[iLightNumber] = result.productname;              });};    //if ( debug ){ console.log(`    ProductName:      ${result.productname}`);};});};
exports.getModelId = function( iLightNumber ){          client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.modelid === undefined ) return err;             exec("/bin/echo '" + result.modelid + "' > " + pathresources + "/hue/light/" + iLightNumber + "/modelid" );                     sArrayLightModelid[iLightNumber] = result.modelid;                      });};    //if ( debug ){ console.log(`    ModelId:          ${result.modelid}`);};});};
exports.getName = function( iLightNumber ){             client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.name === undefined ) return err;                exec("/bin/echo '" + result.name + "' > " + pathresources + "/hue/light/" + iLightNumber + "/name" );                           sArrayLightName[iLightNumber] = result.name;                            });};    //if ( debug ){ console.log(`    Name:             ${result.name}`);};});};
exports.getSwVersion = function( iLightNumber ){        client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.swversion === undefined ) return err;           exec("/bin/echo '" + result.swversion + "' > " + pathresources + "/hue/light/" + iLightNumber + "/swversion" );                 sArrayLightSwversion[iLightNumber] = result.swversion;                  });};    //if ( debug ){ console.log(`    Swversion:        ${result.swversion}`);};});};
exports.getType = function( iLightNumber ){             client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.type === undefined ) return err;                exec("/bin/echo '" + result.type + "' > " + pathresources + "/hue/light/" + iLightNumber + "/type" );                           sArrayLightType[iLightNumber] = result.type;                            });};    //if ( debug ){ console.log(`    Type:             ${result.type}`);};});};
exports.getUniqueid = function( iLightNumber ){         client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.uniqueid === undefined ) return err;            exec("/bin/echo '" + result.uniqueid + "' > " + pathresources + "/hue/light/" + iLightNumber + "/uniqueid" );                   sArrayLightUniqueid[iLightNumber] = result.uniqueid;                    });};    //if ( debug ){ console.log(`    Uniqueid:         ${result.uniqueid}`);};});};
                                                                                                                                                                                           
exports.getOn = function( iLightNumber ){               client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.on === undefined ) return err;            exec("/bin/echo '" + result.state.on + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/on" );                   bArrayLightOn[iLightNumber] = result.state.on;                          });};    //if ( debug ){ console.log(`    On:               ${result.state.on}`);};});};
exports.getBri = function( iLightNumber ){              client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.bri === undefined ) return err;           exec("/bin/echo '" + result.state.bri + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/bri" );                 iArrayLightBriCur[iLightNumber] = result.state.bri;                     });};    //if ( debug ){ console.log(`    Bri:              ${result.state.bri}`);};});};
exports.getHue = function( iLightNumber ){              client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.hue === undefined ) return err;           exec("/bin/echo '" + result.state.hue + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/hue" );                 iArrayLightHueCur[iLightNumber] = result.state.hue;                     });};    //if ( debug ){ console.log(`    Hue:              ${result.state.hue}`);};});}; //10250
exports.getSat = function( iLightNumber ){              client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.sat === undefined ) return err;           exec("/bin/echo '" + result.state.sat + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/sat" );                 iArrayLightSatCur[iLightNumber] = result.state.sat;                     });};    //if ( debug ){ console.log(`    Sat:              ${result.state.sat}`);};});};
exports.getEffect = function( iLightNumber ){           client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.effect === undefined ) return err;        exec("/bin/echo '" + result.state.effect + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/effect" );           sArrayLightEffect[iLightNumber] = result.state.effect;                  });};    //if ( debug ){ console.log(`    Effect:           ${result.state.effect}`);};});};
exports.getXy = function( iLightNumber ){               client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.xy === undefined ) return err;            exec("/bin/echo '" + result.state.xy + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/xy/xy" );                fArrayLightXyCur[iLightNumber] = result.state.xy;                       });};    //if ( debug ){ console.log(`    Xy:               ${result.state.xy}`);};});};
exports.getXyX = function( iLightNumber ){              client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.xy[0] === undefined ) return err;         exec("/bin/echo '" + result.state.xy[0] + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/xy/x" );              fArrayLightXyXCur[iLightNumber] = result.state.xy[0];                   });};    //if ( debug ){ console.log(`    XyX:              ${result.state.xy[0]}`);};});};
exports.getXyY = function( iLightNumber ){              client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.xy[1] === undefined ) return err;         exec("/bin/echo '" + result.state.xy[1] + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/xy/y" );              fArrayLightXyYCur[iLightNumber] = result.state.xy[1];                   });};    //if ( debug ){ console.log(`    XyY:              ${result.state.xy[1]}`);};});};
exports.getCt = function( iLightNumber ){               client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.ct === undefined ) return err;            exec("/bin/echo '" + result.state.ct + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/ct" );                   iArrayLightCtCur[iLightNumber] = result.state.ct;                       });};    //if ( debug ){ console.log(`    Ct:               ${result.state.ct}`);};});};
exports.getAlert = function( iLightNumber ){            client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.alert === undefined ) return err;         exec("/bin/echo '" + result.state.alert + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/alert" );             sArrayLightAlert[iLightNumber] = result.state.alert;                    });};    //if ( debug ){ console.log(`    Alert:            ${result.state.alert}`);};});};
exports.getColormode = function( iLightNumber ){        client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.colormode === undefined ) return err;     exec("/bin/echo '" + result.state.colormode + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/colormode" );     sArrayLightColorMode[iLightNumber] = result.state.colormode;            });};    //if ( debug ){ console.log(`    Colormode:        ${result.state.colormode}`);};});};
exports.getReachable = function( iLightNumber ){        client.getLight( iLightNumber, function( err, result ){ if ( err || typeof result.state.reachable === undefined ) return err;     exec("/bin/echo '" + result.state.reachable + "' > " + pathresources + "/hue/light/" + iLightNumber + "/state/reachable" );     bArrayLightReachable[iLightNumber] = result.state.reachable;            });};    //if ( debug ){ console.log(`    Reachable:        ${result.state.reachable}`);};});};
...
exports.getInfo = function( iLightNumber,sValue){
    ...
    //Output all attributes found
        ...
        if (!fs.existsSync(pathresources + "/hue/light/" + iLightNumber + "/state")) {
                exec("/bin/mkdir -p " + pathresources + "/hue/light/" + iLightNumber + "/state" );
        }
